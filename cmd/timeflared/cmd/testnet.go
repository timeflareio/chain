...
func initAppForTestnet(app *app.App, args valArgs) *app.App {
	// Required Changes:
	//
	// Writes land in the finalize-block state, which the node's first block
	// commits — the v0.55 replacement for the removed direct-write context.
