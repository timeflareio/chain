...
Example:
	timeflared multi-node --v 4 --output-dir ./.testnets --validators-stake-amount 1000000,200000,300000,400000 --list-ports 47222,50434,52851,44210
	`,
...
func addTestnetFlagsToCmd(cmd *cobra.Command) {
	...
	cmd.Flags().String(server.FlagMinGasPrices, fmt.Sprintf("0.1%s", "uveil"), "Minimum gas prices to accept for transactions; All fees in a tx must meet this minimum (e.g. 0.1uveil)")
...
func initTestnetFiles(
	...
	appConfig.BaseConfig.MinGasPrices = "0.1uveil"
...
func collectGenFiles(
	...
	for i := 0; i < numValidators; i++ {
		...
		// time and application state; the node's own AppGenesis carries the
		// chain ID and consensus params, which the export now preserves
