module github.com/timeflareio/chain

go 1.26.5

// Carried pins — every entry needs a reason, tracking reference, and exit
// condition (docs/guides/DEPENDENCIES.md §Carrying local patches). Re-audit
// the whole block on every T2 (consensus-stack) upgrade.
replace (
...
replace github.com/timeflareio/chain/x/secrets/types => ./x/secrets/types
