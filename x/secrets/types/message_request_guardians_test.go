...
func TestMsgUserRequestGuardians_ValidateBasic(t *testing.T) {
	...
	validRevealWindow := &RevealWindow{
		StartOffset: MinRevealStartOffsetTotal, // Minimum valid offset
	...
	tests := []struct {
	...
	}{
		{
			...
			msg: MsgUserRequestGuardians{
				...
				RevealWindow:  validRevealWindow,
				Threshold:     3,
				MinShares:     5,
				MaxShares:     7,
				Bump:          MinBump,
		...
		{
			name: "invalid reveal window - nil",
			msg: MsgUserRequestGuardians{
				Creator:       validCreator,
				DetectionHint: validHint,
				RevealWindow:  nil,
		...
		},
		{
			...
			msg: MsgUserRequestGuardians{
				...
				RevealWindow: &RevealWindow{
					StartOffset: MinRevealStartOffsetTotal - 1,
					Duration:    testRevealDuration,
				},
				Threshold: 3,
				MinShares: 5,
		...
		},
		{
			...
			msg: MsgUserRequestGuardians{
				...
				DetectionHint: validHint,
				RevealWindow: &RevealWindow{
					StartOffset: MaxRevealStartOffset + 1,
					Duration:    testRevealDuration,
				},
				Threshold: 3,
				MinShares: 5,
		...
		{
			name: "invalid reveal window - duration too short",
			msg: MsgUserRequestGuardians{
				Creator:       validCreator,
				DetectionHint: validHint,
				RevealWindow: &RevealWindow{
					StartOffset: MinRevealStartOffsetTotal, // Valid offset for this test
					Duration:    MinRevealDuration - 1,
				},
				Threshold: 3,
				MinShares: 5,
				MaxShares: 7,
		...
		{
			name: "invalid reveal window - duration too long",
			msg: MsgUserRequestGuardians{
				Creator:       validCreator,
				DetectionHint: validHint,
				RevealWindow: &RevealWindow{
					StartOffset: MinRevealStartOffsetTotal, // Valid offset for this test
					Duration:    MaxRevealDuration + 1,
				},
				Threshold: 3,
				MinShares: 5,
				MaxShares: 7,
